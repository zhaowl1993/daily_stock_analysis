...
Analyze your watchlist daily 鈫?generate a decision dashboard 鈫?push to multiple channels (Telegram/Discord/Email/WeChat Work/Feishu)

**Zero-cost deployment** 路 Runs on GitHub Actions 路 No server required

[**Quick Start**](#-quick-start) 路 [**Key Features**](#-key-features) 路 [**Sample Output**](#-sample-output) 路 [**Full Guide**](full-guide_EN.md) 路 [**FAQ**](FAQ_EN.md) 路 [**Changelog**](CHANGELOG.md)

English | [绠�浣撲腑鏂嘳(../README.md) | [绻侀珨涓枃](README_CHT.md)
...
|------------|------|:----:|
| `GEMINI_API_KEY` | Get free API key from [Google AI Studio](https://aistudio.google.com/) | 鉁? |
...
| Secret Name | Description | Required |
|------------|------|:----:|
| `STOCK_LIST` | Watchlist codes, e.g., `600519,AAPL,hk00700` | 鉁?|
...
Go to `Actions` tab 鈫?Click `I understand my workflows, go ahead and enable them`

#### 4. Manual Test

`Actions` 鈫?`Daily Stock Analysis` 鈫?`Run workflow` 鈫?Select mode 鈫?`Run workflow`
...
## 馃摫 Supported Notification Channels

### 1. Telegram (Recommended)

1. Talk to [@BotFather](https://t.me/BotFather) 鈫?`/newbot` 鈫?get Bot Token
...
```markdown
# 馃幆 2026-01-24 Decision Dashboard

> Total **3** stocks analyzed | 馃煝Buy:1 馃煛Hold:1 馃敶Sell:1

## 馃搳 Analysis Summary

馃煝 **AAPL(Apple Inc.)**: Buy | Score 85 | Strong Bullish
馃煛 **600519(Kweichow Moutai)**: Hold | Score 65 | Bullish
馃敶 **TSLA(Tesla)**: Sell | Score 35 | Bearish
...
### 馃摪 Key Information
**馃挱 Sentiment**: Positive news on iPhone 16 sales
**馃搳 Earnings**: Q1 2024 earnings beat expectations

### 馃搶 Core Conclusion

**馃煝 Buy** | Strong Bullish

> **One-sentence Decision**: Strong technical setup with positive catalyst, ideal entry point

鈴?**Time Sensitivity**: Within this week

| Position | Action |
|----------|--------|
| 馃啎 **No Position** | Buy at pullback |
| 馃捈 **With Position** | Continue holding |

### 馃搳 Data Perspective

**MA Alignment**: MA5>MA10>MA20 | Bull Trend: 鉁?Yes | Trend Strength: 85/100
...
| MA10 | $180.50 |
| MA20 | $177.80 |
| Bias (MA5) | +1.26% 鉁?Safe |
| Support | $183.20 |
| Resistance | $190.00 |

**Volume**: Ratio 1.8 (Moderate increase) | Turnover 2.3%
馃挕 *Volume confirms bullish momentum*
...
| Level Type | Price |
|-----------|-------|
| 馃幆 Ideal Entry | $183-184 |
| 馃數 Secondary Entry | $180-181 |
| 馃洃 Stop Loss | $177 |
| 馃帄 Target | $195 |

**馃挵 Position Sizing**: 20-30% of portfolio
- Entry Plan: Enter in 2-3 batches
- Risk Control: Strict stop loss at $177

**鉁?Checklist**

- 鉁?Bull trend confirmed
- 鉁?Price near MA5 support
- 鉁?Volume confirms trend
- 鈿狅笍 Monitor market volatility
...
## 馃З FastAPI Web Service (Optional)
...
- 馃摑 **Configuration Management** - View/modify watchlist
- 馃殌 **Quick Analysis** - Trigger analysis via API
- 馃搳 **Real-time Progress** - Analysis task status updates in real-time, supports parallel tasks
- 馃搱 **Backtest Validation** - Evaluate historical analysis accuracy, query direction win rate and simulated returns
...
## 猸?Star History
**Made with 鉂わ笍 by AI enthusiasts | Star 猸?this repo if you find it useful!**
