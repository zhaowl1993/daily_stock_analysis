...
|------|------|------|----------|
| **Docker Compose** â­?| One-click deploy, isolated environment, easy migration, easy upgrade | Requires Docker installation | **Recommended**: Most scenarios |
...
- âœ?**No server needed**
- âœ?**Auto-scheduled execution**
- âœ?**Zero maintenance cost**

### Limitations
- âš ï¸ Stateless (fresh environment each run)
- âš ï¸ Scheduled timing may have few minutes delay
- âš ï¸ Cannot provide HTTP API
...
Go to repo page â†?**Settings** â†?**Secrets and variables** â†?**Actions** â†?**New repository secret**
...
| `STOCK_LIST` | Watchlist, e.g., `600519,300750` | âœ?|
...
1. Go to repo page â†?**Actions** tab
...
A: Actions â†?Select run record â†?Artifacts â†?Download `analysis-reports-xxx`
